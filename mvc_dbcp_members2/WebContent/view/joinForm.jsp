	...
	<div class="form-group row justify-content-center">
		...
		<div class="col-sm-6">
			<input type="text" name="userid" id="userid" class="form-control" placeholder="아이디를 입력하세요"/>
			 <small id="userid" class="text-info"></small> <%-- 에러 발생시 메세지 나오기 위한 창 --%>
		</div>
	</div>
	<div class="form-group row justify-content-center">
	...
	<label for="pass2" class="col-sm-2 col-form-label">성별 </label>
	  <div class="col-sm-6">
			<div class="form-check form-check-inline">
		  	...
		  	<div class="form-check form-check-inline">
				<input type="radio"  id="gender" name="gender" value="여" class="form-check-input"/>여
			</div>
...
<script src="../js/joinform.js"></script><%-- form validation script --%>
